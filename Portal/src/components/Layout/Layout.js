...
// import ContractorNew from "../../pages/contractor/ContractorNew";
...
function Layout(props) {
  console.log("46", sessionStorage.getItem("user"));
              ...
              if (data === "hr") {
                return (
                  <Switch>
                    ...
                    {/* <Route
                      path="/employee/pendinglist"
                      component={PendingList}
                    /> */}
                    {/* <Route
                      path="/employee/pendingallocation"
                      component={PendingAllocation}
                    />
                    <Route
                      path="/employee/deactivatedlist"
                      component={DeactivatedList}
                    />
                    <Route
                      path="/employee/rejectedlist"
                      component={RejectedList}
                    />
                    <Route
                      path="/employee/leavinglist"
                    ...
                    <Route
                      path="/reports/mpreport"
                      component={ManpowerReport}
                    /> */}
                    {/* <Route
                      path="/reports/reqreport"
                ...
                return (
                  <Switch>
                    <Route path="/dashboard" component={Dashboard} />
                    <Route path="/contractorNew" component={Contractor} />
                    {/* <Route path="/userprofile" component={UserProfile} />
                    <Route path="/leave" component={Leave} />
                    <Route path="/attendance" component={Attendance} />
                    <Route path="/announcement" component={Announcement} />
