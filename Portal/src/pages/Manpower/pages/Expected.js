...
function ExpectedManpower() {
  ...
  useEffect(() => {
    ...
    axios.post('http://localhost:3000/mp/getAllocationData_shell_core', { verified: 'NO', shift: shift }).then((response) => { set_shell_core(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_cold_box', { verified: 'NO', shift: shift }).then((response) => { set_cold_box(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_arpa_900', { verified: 'NO', shift: shift }).then((response) => { set_arpa_900(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_arpa_450', { verified: 'NO', shift: shift }).then((response) => { set_arpa_450(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_w_b_q_3', { verified: 'NO', shift: shift }).then((response) => { set_w_b_q_3(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_hand_moulding', { verified: 'NO', shift: shift }).then((response) => { set_hand_moulding(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_melting', { verified: 'NO', shift: shift }).then((response) => { set_melting(response.data[0].count); });
    axios.post('http://localhost:3000/mp/getAllocationData_fettling', { verified: 'NO', shift: shift }).then((response) => { set_fettling(response.data[0].count); setLoading(false); });
  }, [shift]);
